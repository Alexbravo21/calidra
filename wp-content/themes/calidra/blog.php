                ...
                <?php while($blog_query->have_posts()) : $blog_query->the_post(); ?>
                    <div class="column is-one-third is-flex">
                        <a href="<?=get_post_permalink(); ?>" style="display:block;" class="reliable-old-lady<?php $reliable = array_rand($reliableArray); echo $reliableArray[$reliable]; ?>">
                            <div class="blog-section-mini-cont">
                                <div class="blog-section-mini-cont-text">
                                    <h3><?=get_the_title(); ?></h3>
                                    <p class="blog-section-mini-cont-text-desc"><?=get_field('extracto_blog'); ?></p>
                                    <p class="blog-section-mini-cont-text-meta">
                                        <!-- <span><?php // print_r(get_the_category()[0]->name); ?></span> -->
                                        <?=get_post_time('d-m-Y'); ?>
                                    </p>
                                </div>
                                <div class="blog-section-mini-cont-img">
