(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["bulmaCarousel3"] = factory();
	else
		root["bulmaCarousel3"] = factory();
...
var bulmaCarousel3 = function (_EventEmitter) {
  _inherits(bulmaCarousel3, _EventEmitter);

  function bulmaCarousel3(selector) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    _classCallCheck(this, bulmaCarousel3);

    var _this = _possibleConstructorReturn(this, (bulmaCarousel3.__proto__ || Object.getPrototypeOf(bulmaCarousel3)).call(this));
    ...
    value: function attach() {
      ...
      [].forEach.call(elements, function (element) {
        if (typeof element[_this7.constructor.name] === 'undefined') {
          var instance = new bulmaCarousel3(element, options);
  ...
  return bulmaCarousel3;
}(__WEBPACK_IMPORTED_MODULE_3__utils_eventEmitter__["a" /* default */]);

/* harmony default export */ __webpack_exports__["default"] = (bulmaCarousel3);
...
var Navigation = function () {
	...
	_createClass(Navigation, [{
		...
		value: function init() {
			...
			this._ui = {
				previous: document.querySelector('.slider-prods-previous-calidra'),
				next: document.querySelector('.slider-prods-next-calidra')
			};
